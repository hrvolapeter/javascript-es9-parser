  ...
  if (error) {
    ...
    assert_eq!(
        ...
        vec![
            ...
            Token::Assign,
            Token::IdentifierName(String::from("async")),
            Token::LRound,
            Token::RRound,
            Token::EqualArrow,
            Token::LBrace,
            ...
            Token::LF,
            Token::LF,
            Token::IdentifierName(String::from("try")),
            Token::LBrace,
            Token::LF,
            Token::IdentifierName(String::from("const")),
            ...
            Token::LF,
            Token::LF,
            Token::IdentifierName(String::from("await")),
            Token::IdentifierName(String::from("checkEnvironmentVariables")),
            Token::LRound,
            Token::IdentifierName(String::from("params")),
            Token::RRound,
            ...
            Token::LF,
            Token::RBrace,
            Token::IdentifierName(String::from("catch")),
            Token::LRound,
            ...
            Token::LBrace,
            Token::LF,
            Token::IdentifierName(String::from("if")),
            Token::LRound,
            Token::IdentifierName(String::from("error")),
            Token::RRound,
            Token::LBrace,
            ...
            Token::LF,
            Token::RBrace,
            Token::IdentifierName(String::from("else")),
            Token::LBrace,
            Token::LF,
            Token::IdentifierName(String::from("run")),
            Token::LRound,
